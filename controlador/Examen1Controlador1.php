...
echo "                  <h1>Promedio: ".intval($aux1[1])."% </h1>\n";
echo "                  <button class=\"button button4\" name=\"btn_inicio1\">Salir</button>";
echo "                  </div>\n";
echo "              </div>\n";
echo "            </form>\n";
echo "      </div>\n";
...
//echo "                  <h1>Nota del Examen de Ingenieria Informática y/o de Sistemas : ".$fila1[3]." </h1>\n";
//echo "                  <h1>Nota del Examen de Ingenieria civil: ".$fila1[4]." </h1>\n";
//echo "                  <h1>Nota del Examen de Ingenieria Industrial : ".$fila1[5]." </h1>\n";
echo "                  <button class=\"button button4\" name=\"btn_inicio1\">Salir</button>";
echo "                  </div>\n";
echo "              </div>\n";
echo "            </form>\n";
